...
namespace QLTKB
{
    public partial class frmXepTKB : Form
    {
        ...
        public void khoitaoluoi()
        {
            ...
            msds.Columns[1].HeaderText = "Giảng Viên";
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            if (themmoi == true)
            {
                string sql = "Select count(*) from tblTKB where Ngay =N'" + cbngay.Text + "' and MaGV =N'" + cbgv.Text + "' and Buoi =N'" + cbb.Text + "'";
        ...
        private void msds_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cbb.Text = msds.Rows[dong].Cells[5].Value.ToString();
        }
        ...
        {
            string sql = "Select * from tblTKB where Ngay like '%" + txttim.Text + "%' or MaGV like '%" + txttim.Text + "%' or MaMon like '%" + txttim.Text + "%' or MaLop like '%" + txttim.Text + "%'";
            msds.DataSource = cn.taobang(sql);
        }
