    ...
    public partial class frmPhongHoc : Form
    {
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            if (themmoi == true)
            {
                ...
                {
                    if (MessageBox.Show("Bạn chưa nhập mã phòng học !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information) == DialogResult.OK)
                        txtma.Focus();
                    return;
                }
                if (txtten.Text.Trim().Length == 0)
                {
                    if (MessageBox.Show("Bạn chưa nhập tên phòng học !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information) == DialogResult.OK)
                        txtten.Focus();
                    return;
                }
